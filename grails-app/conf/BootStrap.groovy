...
*/
           ...
           // c1.addToCollections(col1).addToCollections(col3).addToCollections(col4).save();
            ...
            Contact cont = new Contact(firstName: "FirstName4", lastName: "LastName4", email: "kdi1991@gmail.com, zgbi100@mail.ru").save(failOnError: true);
                        ...
                        Contact cont3 = new Contact(firstName: "FirstName3", lastName: "LastName3", email: "zgbi100@mail.ru").save(failOnError: true)
