...
*/
           ...
           // c1.addToCollections(col1).addToCollections(col3).addToCollections(col4).save();
            ...
            Contact cont = new Contact(firstName: "FirstName4", lastName: "LastName4", email: "kdi1991@gmail.com, zgbi100@mail.ru").save().save(failOnError: true);
                        Contact cont1 = new Contact(firstName: "FirstName1", lastName: "LastName1", email: "kdi1979@mail.ru").save().save(failOnError: true);
                        Contact cont2 = new Contact(firstName: "FirstName2", lastName: "LastName2", email: "kdi1980@mail.ru, zgbi100@mail.ru").save(failOnError: true)
                        Contact cont3 = new Contact(firstName: "FirstName3", lastName: "LastName3", email: "zgbi100@mail.ru").save().save(failOnError: true)
