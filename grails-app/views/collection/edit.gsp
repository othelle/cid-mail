	...
	<body>
		...
		<div class="nav" role="navigation">
			<ul>
				...
				<li><g:link class="create" action="create"><g:message code="collection.new.label" args="[entityName]" /></g:link></li>
			</ul>
		</div>
		<div id="edit-collection" class="content scaffold-edit" role="main">
			<h1><g:message code="collection.edit.label" args="[entityName]" /></h1>
