...
<html>
	...
	<body>
		...
		<div id="list-collection" class="content scaffold-list" role="main">
			<h1><g:message code="collection.list.label2" args="[entityName]" /></h1>
			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="email" title="${message(code: 'collection.email.label', default: 'Email')}" />
					
						<g:sortableColumn property="password" title="${message(code: 'collection.password.label', default: 'Password')}" />
					
						<g:sortableColumn property="code" title="${message(code: 'collection.code.label', default: 'Code')}" />
				...
				<g:each in="${collectionInstanceList}" status="i" var="collectionInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: collectionInstance, field: "email")}</td>
					
						<td>${fieldValue(bean: collectionInstance, field: "password")}</td>
