...
<html>
	...
	<body>
		<a href="#create-collection" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-collection" class="content scaffold-create" role="main">
			<h1><g:message code="collection.new.label" /></h1>
