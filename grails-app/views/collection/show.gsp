	...
	<body>
		...
		<div id="show-collection" class="content scaffold-show" role="main">
			...
			<ol class="property-list collection">
				...
				<li class="fieldcontain">
					<span id="email-label" class="property-label"><g:message code="collection.email.label" default="Email" /></span>
					
						<span class="property-value" aria-labelledby="email-label"><g:fieldValue bean="${collectionInstance}" field="email"/></span>
				...
				<li class="fieldcontain">
					<span id="password-label" class="property-label"><g:message code="collection.password.label" default="Password" /></span>
					
						<span class="property-value" aria-labelledby="password-label"><g:fieldValue bean="${collectionInstance}" field="password"/></span>
				...
				<li class="fieldcontain">
					<span id="contacts-label" class="property-label"><g:message code="collection.contacts.label" default="Contacts" /></span>
				...
				<li class="fieldcontain">
					<span id="checkMail-label" class="property-label"><g:message code="checkMail.label" default="Check Mail" /></span>
						...
						<span class="property-value" aria-labelledby="checkMail-label"><g:link controller="checkMail" action="show" id="${c.id}">${c?.subject}</g:link> ${c?.from} ${c?.dateSend} </span>
						</g:each>
				...
				<li class="fieldcontain">
					<span id="code-label" class="property-label"><g:message code="collection.code.label" default="Code" /></span>
					
						<span class="property-value" aria-labelledby="code-label"><g:fieldValue bean="${collectionInstance}" field="code"/></span>
