...
<div id="show-contact" class="content scaffold-show" role="main">
    ...
    <ol class="property-list contact">
        ...
        <g:if test="${contactInstance?.email}">
            <li class="fieldcontain">
                <span id="email-label" class="property-label"><g:message code="contact.organization.label"
        ...
        <g:if test="${contactInstance?.collections}">
            <li class="fieldcontain">
                <span id="collections-label" class="property-label"><g:message code="contact.collections.label"
                                                                               default="Collections"/></span>

                <g:each in="${contactInstance.collections}" var="c">
                    <span class="property-value" aria-labelledby="collections-label"><g:link controller="collection"
                                                                                             action="show"
        ...
        <g:if test="${contactInstance?.localMail}">
            <li class="fieldcontain">
                       <span id="localMail-label" class="property-label"><g:message code="contact.localMail.label"
                                                                                    default="Local Mail"/></span>
            <ul>
                <g:each in="${contactInstance.localMail}" var="l">
                    <li><span class="property-value" aria-labelledby="localMail-label">
                    <g:message code="localMail.subject.label" default="Тема"/>:&nbsp;
                    <g:link controller="localMail" action="show" id="${l.id}">${l?.subject}</g:link>
                    </br>
                    <g:message code="localMail.contact.label" default="Кому"/>:&nbsp;${l?.contact}</br><g:message
                        code="localMail.dateSent.label" default="Дата отправки"/>:&nbsp;${l?.dateSent}</br></br></span></li>
