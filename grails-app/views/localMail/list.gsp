...
<body>
<a href="#list-localMail" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
...
<div id="list-localMail" class="content scaffold-list" role="main">
    <h1><g:message code="localMail.label" args="[entityName]"/></h1>
    ...
    <table>
        ...
        <tr>
            ...
            <g:sortableColumn property="description"
                              title="${message(code: 'localMail.description.label', default: 'Description')}"/>
        ...
        <g:each in="${localMailInstanceList}" status="i" var="localMailInstance">
            <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                ...
                <td><g:link action="show"
                            id="${localMailInstance.id}">${fieldValue(bean: localMailInstance, field: "description")}</g:link>
                </td>
