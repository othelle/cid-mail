...
<body>
	...
	<div class="nav" role="navigation">
		<ul>
			...
			<li><g:link class="create" action="create">
					<g:message code="localMail.new.label" />
				</g:link></li>
	...
	<div id="list-localMail" class="content scaffold-list" role="main">
		<h1>
			<g:message code="localMail.label" args="[entityName]" />
		</h1>
		...
		<table>
			...
			<tbody>
				<g:each in="${localMailInstanceList}" status="i"
						...
						<td><g:link action="show" id="${localMailInstance.id}">
								...
								<li class="fieldcontain"><span id="attachment-label"
									class="property-label"><g:message
											code="checkMail.attachment.label" default="Attachment" /></span> <g:each
										in="${localMailInstance.attachment}" var="a">
